...
class Controller:
    ...
    def align(self, path):
        ...
        aligned_bits = get_img_bits(Image.open(aligned_path).resize(Config.gui.display_size)) #get_img_bits(Image.fromarray(load_numpy(aligned_path, Config.generation.device).numpy()))
